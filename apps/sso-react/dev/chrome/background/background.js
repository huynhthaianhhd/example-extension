...
var webextension_polyfill_1 = __webpack_require__(/*! webextension-polyfill */ "./node_modules/.pnpm/webextension-polyfill@0.10.0/node_modules/webextension-polyfill/dist/browser-polyfill.js");
var OIDC_CLIENT_ID = '2cae5412-1ff5-4081-b51c-20a7ac319374';
var OIDC_SCOPE = 'openid offline';
var OIDC_AUTHORIZATION_ENDPOINT = 'https://api-gateway.skymavis.one/oauth2/auth';
                ...
                try {
                    ...
                    switch (message.type) {
                        case 'login': {
                            ...
                            url = "".concat(OIDC_AUTHORIZATION_ENDPOINT, "?").concat(query.toString());
                            console.log('SIGN IN URL: ', url);
                            browser.identity.launchWebAuthFlow({ url: url, interactive: true }, function (callbackUrl) {
                                return __awaiter(this, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_a) {
                                        ...
                                        webextension_polyfill_1.storage.local.set({ token: code });
                                        return [2 /*return*/];
                                    });
                                });
                            });
